...
ARRAY_HEAD(CommandsData, struct Command);
struct CommandsData commands = ARRAY_HEAD_INITIALIZER;
...
/**
 * commands_cmp - Compare two commands by name
 */
